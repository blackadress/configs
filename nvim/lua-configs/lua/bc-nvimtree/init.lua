...
glob.nvim_tree_hide_dotfiles = 0 -- "0 by default, this option hides files and folders starting with a dot `.`
...
glob.nvim_tree_tab_open = 0 -- "0 by default, will open the tree when entering a new tab and the tree was previously open
...
glob.nvim_tree_hijack_netrw = 1 -- "1 by default, prevents netrw from automatically opening when opening directories (but lets you keep its other utilities)
